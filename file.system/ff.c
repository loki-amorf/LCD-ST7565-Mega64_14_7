...
#define DBG_FILE_SYSTEM

//#ifdef DBG_FILE_SYSTEM
//#define DBG_OUT(...)	printf(__VA_ARGS__)
//#else
//#define DBG_OUT(...)
//#endif	/* #ifdef DBG_FILE_SYSTEM */
...
Print errors
******************************************************************************/
void f_PrintError(FRESULT res)
{
	#ifdef DBG_FILE_SYSTEM
	switch(res)
	{
		case FR_OK:
		PRINTF("FileSystem: OK. (0) Succeeded\r\n");
		break;
		
		case FR_DISK_ERR:
		PRINTF("FileSystem:(1) A hard error occurred in the low level disk I/O layer\r\n");
		break;
		
		case FR_INT_ERR:
		PRINTF("FileSystem:(2) Assertion failed\r\n");
		break;
		
		case FR_NOT_READY:
		PRINTF("FileSystem:(3) The physical drive cannot work\r\n");
		break;
		
		case FR_NO_FILE:
		PRINTF("FileSystem:(4) Could not find the file\r\n");
		break;
		
		case FR_NO_PATH:
		PRINTF("FileSystem:(5) Could not find the path\r\n");
		break;
		
		case FR_INVALID_NAME:
		PRINTF("FileSystem:(6) The path name format is invalid\r\n");
		break;
		
		case FR_DENIED:
		PRINTF("FileSystem:(7) Access denied due to prohibited access or directory full\r\n");
		break;
		
		case FR_EXIST:
		PRINTF("FileSystem:(8) Access denied due to prohibited access\r\n");
		break;
		
		case FR_INVALID_OBJECT:
		PRINTF("FileSystem:(9) The file/directory object is invalid\r\n");
		break;
		
		case FR_WRITE_PROTECTED:
		PRINTF("FileSystem:(10) The physical drive is write protected\r\n");
		break;
		
		case FR_INVALID_DRIVE:
		PRINTF("FileSystem:(11) The logical drive number is invalid\r\n");
		break;
		
		case FR_NOT_ENABLED:
		PRINTF("FileSystem: Not enabled!(12) The volume has no work area\r\n");
		break;
		
		case FR_NO_FILESYSTEM:
		PRINTF("FileSystem: No file system!(13) There is no valid FAT volume\r\n");
		break;
		
		case FR_MKFS_ABORTED:
		PRINTF("FileSystem:(14) The f_mkfs() aborted due to any parameter error\r\n");
		break;
		
		case FR_TIMEOUT:
		PRINTF("FileSystem:(15) Could not get a grant to access the volume within defined period\r\n");
		break;
		
		case FR_LOCKED:
		PRINTF("FileSystem:(16) The operation is rejected according to the file sharing policy\r\n");
		break;
		
		case FR_NOT_ENOUGH_CORE:
		PRINTF("FileSystem:(17) LFN working buffer could not be allocated\r\n");
		break;
		
		case FR_TOO_MANY_OPEN_FILES:
		PRINTF("FileSystem:(18) Number of open files > _FS_SHARE\r\n");
		break;
		
		case FR_INVALID_PARAMETER:
		PRINTF("FileSystem:(19) Given parameter is invalid\r\n");
		break;
		
		default:
		PRINTF("FileSystem: Unkown result!\r\n");
		break;
	}
	#endif /* #if DBG_FILE_SYSTEM */
}