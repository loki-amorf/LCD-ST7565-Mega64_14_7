...
/*если не определена тактова€ частота, определ€ем ее здесь*/
#ifndef F_CPU
...
//    lcd_sendcmd('\xF8'); //ѕо даташиту
//    lcd_sendcmd('\x00'); //ѕо даташиту 
    lcd_sendcmd('\x26');  //так было
//    lcd_sendcmd('\x00'); //???
//    lcd_sendcmd('\x10'); //???
...
//    TCC0_CCB = s * 125; //это вытер €
//    PORTC.DIRSET = PIN1_bm;       //
//    if (s) PORTC.OUTSET=PIN1_bm;  //остальное уже было закомментировано
