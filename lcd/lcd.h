...
#define LCD_ST7565R_DEFAULT_CONTRAST 30

#define LCD_ST7565R_CMD_NORMAL_COMMON_OUTPUT_MODE_SELECT  '\xC0'
#define LCD_ST7565R_CMD_REVERSE_COMMON_OUTPUT_MODE_SELECT '\xC8'  
